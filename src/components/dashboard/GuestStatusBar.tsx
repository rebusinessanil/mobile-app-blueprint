...
export default function GuestStatusBar() {
  ...
  const [activeUsers, setActiveUsers] = useState(() => Math.floor(Math.random() * (180 - 150 + 1)) + 150);
  ...
  return <div className="mx-4 mt-4">
      ...
      ease: "easeOut"
        ...
        <div onClick={() => navigate("/login")} className="relative flex items-center justify-between px-4 py-3 cursor-pointer hover:bg-white/5 transition-colors">
