  ...
  return (
    <>
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform z-[9999]"
      >
        <img src="/lovable-uploads/f75a5ed3-52e3-4ed9-b0e4-5960eac6f78c.png" alt="WhatsApp" className="w-8 h-8" />
      </a>
      
      <div className="h-screen bg-navy-dark flex items-center justify-center p-3 overflow-hidden">
