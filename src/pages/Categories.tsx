...
export default function Categories() {
  ...
  const categories = [
    ...
    { icon: Gift, label: "Bonanza Promotion", color: "bg-red-600", path: "/bonanza-banner-create" },
    { icon: Calendar, label: "Birthday Banner", color: "bg-teal-600", path: "/birthday-banner-create" },
    { icon: Star, label: "Anniversary Banner", color: "bg-blue-600", path: "/anniversary-banner-create" },
    { icon: MessageCircle, label: "Thank You Message", color: "bg-green-600", path: "/category/thank-you-message" },
    { icon: Zap, label: "Motivational Quote", color: "bg-yellow-600", path: "/motivational-banner-create" },
    { icon: Calendar, label: "Festival Banner", color: "bg-purple-600", path: "/festival-banner-create" },
    ...
    { icon: Users, label: "Event / Meeting", color: "bg-yellow-600", path: "/meeting-banner-create" },
