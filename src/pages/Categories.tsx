...
export default function Categories() {
  ...
  const categories = [
    ...
    { icon: MessageCircle, label: "Thank You Message", color: "bg-green-600", path: "/coming-soon" },
    ...
    { icon: Target, label: "Weekly Achievement", color: "bg-teal-600", path: "/coming-soon" },
    { icon: Briefcase, label: "Special Campaign", color: "bg-yellow-700", path: "/coming-soon" },
    { icon: Medal, label: "Achievements", color: "bg-purple-600", path: "/coming-soon" },
    { icon: Image, label: "Custom Banner", color: "bg-blue-700", path: "/coming-soon" },
    { icon: Users, label: "Event / Meeting", color: "bg-yellow-600", path: "/banner-create/meeting" },
    { icon: Users, label: "New Joiner Banner", color: "bg-teal-700", path: "/coming-soon" },
    { icon: IndianRupee, label: "Income Banner", color: "bg-green-700", path: "/coming-soon" },
    { icon: BarChart3, label: "Capping Banner", color: "bg-red-700", path: "/coming-soon" },
  ];
