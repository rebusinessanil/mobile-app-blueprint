              ...
              <div className="absolute inset-0">
                ...
                <div className="banner-text-content absolute" style={{
                  ...
                  <h2 title={mainBannerName.toUpperCase()} style={{
                      ...
                      textAlign: 'center',
                      margin: '0 auto'
                    }} className="banner-preview-name text-center my-0 py-[4px]">
                  ...
                  {bannerData.teamCity && <p title={bannerData.teamCity.toUpperCase()} style={{
                      ...
                      color: '#ffffff',
                      textAlign: 'center'
                    }} className="banner-team text-center py-[5px]">
                ...
                <div className="absolute" style={{
                  ...
                  <p title={`+91 ${displayContact}`} style={{
                      ...
                      color: '#ffffff',
                      fontFamily: 'sans-serif'
                    }} className="banner-contact py-[5px]">
                    +91 {displayContact}
                  </p>
                </div>
                ...
                <div className="absolute text-center" style={{
                  ...
                  <p title={profileName} style={{
                      ...
                      color: '#ffffff',
                      textAlign: 'center'
                    }} className="banner-profile-name my-0 mx-0 py-[5px]">
                  ...
                  <p style={{
                      ...
                      color: '#eab308',
                      textAlign: 'center'
                    }} className="banner-profile-rank py-[5px]">
                    {displayRank}
                  </p>
                </div>
