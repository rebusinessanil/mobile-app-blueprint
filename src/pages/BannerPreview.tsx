          ...
          <div ref={bannerRef} className="border-4 border-primary rounded-2xl overflow-hidden shadow-2xl">
            ...
            paddingBottom: '100%'
              ...
              <div className="absolute inset-0">
                ...
                right: '6%',
                width: '48%'
              }} className="absolute py-0 px-0 mx-[125px] my-[57px]">
                  <h2 style={{
                  fontSize: 'clamp(32px,6.5vw,68px)',
                  textShadow: '3px 3px 6px rgba(0,0,0,0.8)',
                  letterSpacing: '0.05em'
                }} className="text-white leading-none tracking-wider text-base my-0 py-[5px] mx-[24px] px-[19px] text-center font-serif font-thin">
                    {bannerData.name.toUpperCase()}
                  </h2>
                  {bannerData.teamCity && <p style={{
                  fontSize: 'clamp(16px,3vw,32px)',
                  textShadow: '2px 2px 4px rgba(0,0,0,0.8)'
                }} className="text-white mt-2 tracking-widest py-0 text-center font-sans px-0 text-xs font-thin mx-[45px] my-0">
                ...
                left: '2%',
                width: '55%'
              }} className="absolute my-[237px] mx-[9px]">
                    <p style={{
                  fontSize: 'clamp(10px,1.8vw,16px)',
                  letterSpacing: '0.1em'
                }} className="text-white leading-tight mb-1 text-xs font-thin text-left my-0 px-0 py-0 mx-[4px]">
                      THIS WEEK INCOME 
                    </p>
                    <p style={{
                ...
                }} className="leading-none text-3xl text-yellow-400 font-sans font-extrabold mx-0 my-0 py-0 px-0">
                ...
                left: '2%'
                  ...
                  color: '#FFFFFF',
                  textShadow: '2px 2px 4px rgba(0,0,0,0.8)'
                }} className="leading-tight text-xs font-extralight font-serif text-left mx-[3px] my-0 px-0 py-0">
                    +91 {displayContact}
                  </p>
                </div>
