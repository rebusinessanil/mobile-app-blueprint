...
export default function MeetingBannerCreate() {
      ...
      <div className="px-6 py-6 space-y-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 pt-2">
            ...
            <h1 className="text-3xl font-bold text-primary mb-1">Event / Meeting</h1>
            <p className="text-lg text-blue-400">Event Details</p>
          </div>
        </div>
        ...
        <div className="flex gap-4">
          <div className="flex-1 space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-sm text-foreground">Event Title <span className="text-muted-foreground">(optional)</span></label>
              <Input 
            ...
            <div className="space-y-2">
              <label className="text-sm text-foreground">Venue <span className="text-muted-foreground">(optional)</span></label>
              <Input 
