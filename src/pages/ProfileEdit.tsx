...
export default function ProfileEdit() {
  ...
  return <>
    ...
    <div className="min-h-screen bg-navy-dark pb-4">
      {/* Header */}
      <header className="sticky top-0 bg-navy-dark/95 backdrop-blur-sm z-40 px-4 py-2 border-b border-primary/20">
        <div className="flex items-center justify-between">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-foreground">Update your profile details</p>
          </div>
          <div className="w-8" />
        </div>
      </header>
          ...
          <div className="flex gap-3 items-center">
            <div className="flex-1 space-y-1">
              ...
              <Select value={formData.language} onValueChange={value => setFormData({
                ...
                <SelectTrigger className="gold-border bg-secondary text-foreground h-9 text-sm">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="bg-card border-primary">
            ...
            <div className="flex-1 space-y-1">
              ...
              <div className="flex gap-2 justify-center">
                <button onClick={() => setFormData({
                  ...formData,
                  gender: "male"
                })} className={`w-9 h-9 rounded-full flex items-center justify-center transition-all ${formData.gender === "male" ? "bg-primary ring-2 ring-primary ring-offset-1 ring-offset-card" : "bg-secondary border border-primary/30"}`}>
                  <span className="text-lg">👨</span>
                </button>
                <button onClick={() => setFormData({
                  ...formData,
                  gender: "female"
                })} className={`w-9 h-9 rounded-full flex items-center justify-center transition-all ${formData.gender === "female" ? "bg-primary ring-2 ring-primary ring-offset-1 ring-offset-card" : "bg-secondary border border-primary/30"}`}>
                  <span className="text-lg">👩</span>
                </button>
              </div>
            </div>
